...
public class Game implements PlayingPieceListener, PlayerListener,
     ...
     * @param gameLogStream
     *            the output stream where important game events will be logged
     */
    public Game(int nPieces, OutputStream gameLogStream) {
        this(BoardFactory.createStandardBoard(), nPieces, gameLogStream);
    }
